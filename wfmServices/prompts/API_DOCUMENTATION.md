# WFM System API Documentation

## 🚀 System Overview

The WFM (Workforce Management) system consists of 7 microservices with comprehensive API endpoints. This document provides all endpoints, sample payloads, and the recommended execution sequence.

## 📋 Service Architecture

| Service | Port | Base URL | Description |
|---------|------|----------|-------------|
| Auth Service | 8000 | `http://localhost:8000` | Authentication & Authorization |
| Config Service | 8002 | `http://localhost:8002` | Configuration Management |
| Rules Service | 8001 | `http://localhost:8001` | Rules Engine |
| Scheduler Service | 8005 | `http://localhost:8005` | Job Scheduling |
| Issue Service | 8003 | `http://localhost:8003` | Issue Management |
| Analytics Service | 8004 | `http://localhost:8004` | Analytics & Reporting |
